...
public class AssetsConstants {
    ...
    public static final String MAP_PREFIX_PATH = "xl/map/map";
    public static final String MAP_POSTFIX_PATH = ".tmx";

    public static final String MAIN_MENU_ATLAS_PATH = "xl/img/main_menu/main_menu.pack.atlas";
    public static final String MAIN_MENU_SKIN_PATH = "xl/img/main_menu/main_menu_skin.json";
